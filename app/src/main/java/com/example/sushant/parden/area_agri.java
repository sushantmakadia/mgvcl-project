...
public class area_agri extends Activity implements AdapterView.OnItemSelectedListener{
    RelativeLayout l1;
    Button b2;
    static String CIRCLE_A,DIV_A,SUB_A;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_area_agri);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(area_agri.this,mgvcl12.class);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        CIRCLE_A= (String) spin0.getSelectedItem();
        DIV_A= (String) spin1.getSelectedItem();
        SUB_A= (String) spin2.getSelectedItem();
