...
public class area_comm extends Activity implements AdapterView.OnItemSelectedListener{
    RelativeLayout l1;
    Button b2;
    static String CIRCLE_C,DIV_C,SUB_C;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_area_comm);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(area_comm.this,com.class);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        CIRCLE_C= (String) spin0.getSelectedItem();
        DIV_C= (String) spin1.getSelectedItem();
        SUB_C= (String) spin2.getSelectedItem();
