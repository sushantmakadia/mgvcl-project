...
public class area_rural extends Activity implements AdapterView.OnItemSelectedListener{
    RelativeLayout l1;
    static String CIRCLE_R,DIV_R,SUB_R;
    Button b2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_area_rural);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        CIRCLE_R = (String) spin0.getSelectedItem();
        DIV_R = (String) spin1.getSelectedItem();
        SUB_R = (String) spin2.getSelectedItem();
        b2=findViewById(R.id.b2);
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(area_rural.this,page1.class);
